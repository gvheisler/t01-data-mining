...
####
#adicionando coluna de resultados no df e retirando as colunas de pontos
####
df <- cbind(df, res)
df <- df[,-c(2,3)]

####
#exclusão da linha de empate
####
...
#parametros minlen e maxlen servem pra mostrar a quantidade desejada de jogadores
####
